...
Der OCM (\textit{On Chip Memory}) ist ein kleiner Speicher im Zynq der direkt ohne Initialisierung verwendet werden kann. 
...
Das geschieht noch bevor die erste Instruktion aus dem User-Code, also auch vor dem selbst geschriebenen Bootloader, ausgeführt wird.
