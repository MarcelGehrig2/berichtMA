...
\item Systemebene
	...
	\item Als fertiges Modul erhältlich: Ein eigenes PCB entwickeln und herstellen ist keine Option.
...
\begin{itemize}
	...
	\item \textbf{Hardware Breakpoint auf einer Speicherstelle (Watchpoint)} 
