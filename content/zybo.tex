...
\chapter{Zybo}
% TODO: Text
Das Zybo ist ein Experimentierboard für den Zynq-7000.
Es beinhaltet die notwendige Hardware, wie Signaltransformatoren und Buchsen, für Ethernet, USB, HDMI und VGA.
Neben der Stromversorgung liefert es auch ein JTAG-Interface um den Zynq zu debuggen. 
...
% TODO Seite XXX
Auf der Seite XXX des ARMv7-A ARM\cite{bib:ARMv7ArchitectureReferenceManual} (\textit{Architecture Reference Manual}) ist beschrieben, wie die unterstützten Features aus den Registern gelesen werden können.
