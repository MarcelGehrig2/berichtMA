...
\lstloadlanguages{C,C++,tcl} % entsprechende Sprachen werden hier schon mal geladen, damit das Übersetzen schneller geht
\lstset{%
  language=C,
...
\newcommand{\shellcmd}[1]{\colorbox{codegray}{\texttt{\scriptsize\# #1}}}

%\definecolor{codegray}{gray}{0.7}
\newcommand{\shelloutput}[1]{\colorbox{black}{\texttt{\scriptsize \textcolor{white}{#1}}}}
%\newcommand{\shelloutput}[1]{\colorbox{black}{\texttt{\scriptsize #1}}}
...
\ihead{MA: Java on the bare ARM metal}
\ohead{\headmark}
...
\title{MA: Java on the bare ARM metal 2018}
...
\usepackage[
  pdftitle={MA: Java on the bare ARM metal 2018},
  pdfauthor={Marcel Gehrig},
  pdfcreator={Texmaker},
  pdfsubject=pdftitle,
  pdfkeywords={Schlussbericht,Masterarbeit,Master,deep,Masterthesis,ARM,Java}]{hyperref}
